    ...
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                <h3 class="box-title" style="margin-bottom: 15px">@lang('site.products')  (# <span>{{$products->total()}}</span>)</h3>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach ($products as $index=>$product)
                                <tr>
                                    ...
                                    <td><img src="{{$product->image_path}}"  style="width: 100px" class="img-fluid img-thumbnail"></td>
